function heatmap_correlation(data_folder, N, file_name, consistency_strength_idx, save_path, save_name, save_data, save_figs)
...
corr_coeff_BP_correct = simu_out.pair_corr_coeff_BP_correct(:,:,:);
corr_coeff_BP_error = simu_out.pair_corr_coeff_BP_error(:,:,:);
